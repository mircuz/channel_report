...
\par
For a tiny cluster this kind of approach could be a good choice, since the decomposition limit varies with the lowest dimension, in this case, $N_{x}$ or $N_{z}$. However the speedup is limited. 
\par
...
\end{center}
\end{figure}
Parlare delle performance e limiti

\subsubsection{fftMPI}
