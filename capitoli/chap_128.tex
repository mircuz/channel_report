...
The green dashed line represent the theoretical limit and has been obtained by dividing the single core time with the number of cores of the simulation.  \\
...
\caption{Comparison of a 3D FFT vs DNS with fftMPI}
\label{643}
\end{center}
\end{figure}
